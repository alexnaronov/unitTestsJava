	...
	public Paint_App() {
		this.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
	          ...
	          endDrag = startDrag;
	          if(Main.selectShap == "move"){
		          for(int i = Main.paint.size() - 1; i>=0; i=i-1){
		        	  Paint pt = Main.paint.get(i);
	        		  if(pt.contains(startDrag)){
	        			  ptemp = pt;
	        			  Main.paint.remove(pt);
	        			  break;
	        		  }
		          }
	          }
	          else if(Main.selectShap == "Delete" ){
		          for(int i = Main.paint.size() - 1; i>=0; i=i-1){
		        	  Paint pt = Main.paint.get(i);
		        	    if(pt.contains(startDrag)){
		        			  ptemp = null;
	        ...
	        public void mouseReleased(MouseEvent e) {
	        	...
	        	if(Main.selectShap == "Rectangle"){
	        		MyRectangle obj = new MyRectangle();
	        		obj.makeObject(startDrag, p);
	    			Main.paint.add(obj);
	        	}
	        	else if(Main.selectShap == "Square"){
	        		MySquare obj = new MySquare();
	        		obj.makeObject(startDrag, p);
	    			Main.paint.add(obj);
	        	}
	        	else if(Main.selectShap == "Triangle"){
	        		MyTriangle obj = new MyTriangle();
	        		obj.makeObject(startDrag, p);
	    			Main.paint.add(obj);
	        	}
	        	else if(Main.selectShap == "Oval"){
	        		MyOval obj = new MyOval();
	        		obj.makeObject(startDrag, p);
	    			Main.paint.add(obj);
	        	}
	        	else if(Main.selectShap == "Circle"){
	        		MyCircle obj = new MyCircle();
	        		obj.makeObject(startDrag, p);
	    			Main.paint.add(obj);
	        	}
	        	else if(Main.selectShap == "Point"){
	        		MyPoint obj = new MyPoint();
	        		obj.makeObject(startDrag, p);
	    			Main.paint.add(obj);
	        	}
	        	else if(Main.selectShap == "Line"){
	        		MyLine obj = new MyLine(startDrag, new Point(e.getX(),  e.getY()), Main.selectColor);
	        		obj.makeObject(startDrag, p);
	    			Main.paint.add(obj);
	        	}
	        	else if(Main.selectShap == "fill"){
	        		for(int i = Main.paint.size() - 1; i>=0; i=i-1){
	        			Paint pt = Main.paint.get(i);
	        			try{
